        ...
        <AnimatedReveal>
          <div className="glass-card h-full rounded-[2rem] p-6 sm:p-8">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-3">
              <Link href="https://sd.itera.ac.id/" target="_blank" rel="noreferrer" className="group rounded-3xl border border-[color:var(--border)] bg-white/90 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-blue-200">
                <div className="flex items-center gap-3">
                  <span className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-2xl border border-blue-100 bg-white shadow-sm">
                    <img src="/logo-sains%20data%20itera.png?v=2" alt="Sains Data ITERA" width={48} height={48} className="h-12 w-12 rounded-2xl object-cover" />
                  </span>
                  <div>
                    <p className="text-sm font-semibold text-slate-950">Sains Data ITERA</p>
                    <p className="text-xs text-[color:var(--muted)]">Data Science home base</p>
                  </div>
                </div>
              </Link>
              <Link href={site.github} target="_blank" rel="noreferrer" className="group rounded-3xl border border-[color:var(--border)] bg-white/90 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-blue-200">
                <div className="flex items-center gap-3">
                  <span className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-2xl border border-blue-100 bg-white shadow-sm">
                    <Image src="/github.webp" alt="GitHub" width={48} height={48} className="h-12 w-12 object-cover" />
                  </span>
                  <div>
                    <p className="text-sm font-semibold text-slate-950">GitHub</p>
                    <p className="text-xs text-[color:var(--muted)]">Project repositories</p>
                  </div>
                </div>
              </Link>
              <Link href={site.linkedin} target="_blank" rel="noreferrer" className="group rounded-3xl border border-[color:var(--border)] bg-white/90 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-blue-200">
                <div className="flex items-center gap-3">
                  <span className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-2xl border border-blue-100 bg-white shadow-sm">
                    <img src="/linkedin.webp" alt="LinkedIn" width={48} height={48} className="h-12 w-12 rounded-2xl object-cover" />
                  </span>
                  <div>
                    <p className="text-sm font-semibold text-slate-950">LinkedIn</p>
                    <p className="text-xs text-[color:var(--muted)]">Professional updates</p>
                  </div>
                </div>
              </Link>
            </div>
