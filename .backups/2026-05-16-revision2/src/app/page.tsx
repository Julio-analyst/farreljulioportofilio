      ...
      <section className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        <AnimatedReveal className="space-y-8">
          ...
          <Link
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex w-fit items-center gap-3 rounded-3xl border border-[color:var(--border)] bg-white/85 px-4 py-3 text-sm font-medium text-slate-800 transition-all duration-300 hover:-translate-y-0.5 hover:border-blue-200 hover:text-[color:var(--accent)]"
          >
            <span className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-2xl border border-blue-100 bg-white shadow-sm">
              <Image
                src="/logo-sains%20data%20itera.png"
                alt="Logo Sains Data ITERA"
                width={40}
                height={40}
